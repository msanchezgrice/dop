  ...
  return (
    <main>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-900 via-violet-800 to-purple-800"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center text-white">
            <span className="inline-block px-4 py-2 rounded-full bg-white bg-opacity-20 text-white text-sm font-medium mb-6">Early Access</span>
        ...
        <div className="grid md:grid-cols-5 gap-12">
          ...
          <div className="md:col-span-2">
            <div className="bg-slate-50 p-6 rounded-xl sticky top-24">
              <div className="mb-6">
                <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80" alt="Gaming team" className="w-full h-auto rounded-lg" />
              </div>
