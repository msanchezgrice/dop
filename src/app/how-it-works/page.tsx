  ...
  return (
    <main>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-teal-800 via-blue-800 to-sky-700"></div>
        <div className="absolute inset-0 opacity-20" style={{ 
          backgroundImage: "url('https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')", 
          backgroundSize: "cover",
          backgroundPosition: "center"
        }}></div>
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-white">
          <div className="max-w-3xl mx-auto text-center">
            <span className="inline-block px-4 py-2 rounded-full bg-white bg-opacity-20 text-white text-sm font-medium mb-6">Integration Guide</span>
        ...
        <div className="space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 custom-box-shadow order-1 md:order-2">
              <img src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1074&q=80" alt="Slack Interface" className="w-full h-auto rounded-lg mb-4" />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white rounded-xl shadow-lg p-6 custom-box-shadow">
              <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80" alt="Data Analytics Dashboard" className="w-full h-auto rounded-lg mb-4" />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 custom-box-shadow order-1 md:order-2">
              <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80" alt="Team Meeting" className="w-full h-auto rounded-lg mb-4" />
              <div className="bg-slate-800 rounded-t-lg p-4 flex items-center">
                <div className="flex space-x-2">
                  <div className="w-3 h-3 rounded-full bg-red-500"></div>
                  <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
      ...
      <Section bgColor="white">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-8 shadow-lg">
            <img src="https://images.unsplash.com/photo-1563013544-824ae1b704d3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80" alt="Security" className="w-full h-auto rounded-lg mb-6" />
